...
const ARTICLES = [
  ...
  { id: 'int-tripleseat', tags: ['tripleseat','crm','venue crm','lead','integration','sync','connect'], title: 'Connecting Tripleseat',            body: 'Tripleseat sends every new StoryVenue lead into Tripleseat automatically. Connect at Settings Integrations Tripleseat, paste your Tripleseat public API key, and pick a location if you have more than one. Sends name, email, phone, date, guest count, message, and UTM source, labeled source StoryVenue - Bride Booking System. One-way. Send test lead to confirm.' },
  { id: 'int-eventtemple', tags: ['event temple','eventtemple','crm','venue crm','lead','booking','integration','connect'], title: 'Connecting Event Temple',    body: 'Event Temple sends every new StoryVenue lead in as a lead booking. Connect at Settings Integrations Event Temple with your API key and API-ORG. Creates a contact plus a lead booking with the event date; message, guest count, source StoryVenue - Bride Booking System, and UTM go into a note. One-way. Send test lead to confirm.' },
  { id: 'int-honeybook', tags: ['honeybook','zapier','crm','lead','integration','connect','automation'], title: 'Connecting HoneyBook via Zapier',       body: 'HoneyBook has no direct connection but you can send leads via Zapier. Generate a StoryVenue API key in Settings Integrations Zapier, build a Zap with the StoryVenue New Lead trigger and a HoneyBook Create Client or Create Project action, and map name, email, phone. Requires HoneyBook Essential or Premium. Custom fields go into project notes.' },
  { id: 'listing-lead-link', tags: ['lead link','link in bio','link tree','linktree','instagram','tiktok','social','bio link','landing page'], title: 'Lead Link — your link-in-bio landing page', body: 'Lead Link is a ready-made link-in-bio landing page at your storyvenue.com address ending in /links. Path Venue listing Lead Link. Auto-fills your venue name, photo, and social handles. Always shows Venue listing and Download Pricing and Availability buttons; the download button opens a lead-capture form that creates a real lead. iPhone-style live preview.' },
  { id: 'listing-lead-link-custom', tags: ['lead link','custom links','buttons','icons','qr code','print','tracking','clicks','booking funnel','source'], title: 'Lead Link custom buttons, QR code, and tracking', body: 'On the Lead Link page add up to 3 custom buttons, each with an icon, label, and URL; custom links open in a new tab. Generate a QR code to print on table cards and signage. The dashboard tracks page views and button clicks and respects date filters. Leads from the Lead Link show as their own Lead Link source in the Booking Funnel.' },
  // Wedding Planner
  { id: 'wedding-planner-overview', tags: ['wedding hub','bride portal','couple portal','portal','shared','connect couple','booked couple','planning','invite couple'], title: 'Wedding Planner — one shared place for you and your couples', body: 'Wedding Planner is one shared place for you and each booked couple to plan the wedding — guest list, RSVPs, seating, meal selections, and messaging. Sidebar Wedding Planner, top-level heart icon, /dashboard/wedding-planner. The couple sees the same Wedding Planner in their own login. Connect both ways: you invite the couple by email, or they request you; the venue approves the link. Included on private-client Legacy and All-Inclusive plans; an add-on on the $97 and Free plans with a schedule-a-demo lock.' },
  { id: 'wedding-planner-guests-seating', tags: ['wedding hub','guest list','rsvp','meal','dietary','headcount','seating','tables','seating chart','beo'], title: 'Wedding Planner — guest lists, RSVPs, and seating', body: 'The couple owns their guest list (names, party size, meal choice, dietary notes, groups) and emails self-service RSVP links to guests. The venue sees a live rollup: attending, declined, awaiting, headcount, and meal tallies for the BEO — but not guest emails, phones, or addresses. The couple builds a seating chart with reception tables and seats each party; the venue sees the table layout with seated and capacity counts. The venue controls which wedding details the couple sees: wedding date, guest count, space, coordinator.' },
  { id: 'wedding-planner-website', tags: ['wedding website','wedding site','minisite','link in bio','linktree','couple website','rsvp online','guestbook','countdown','registry link','the knot','zola'], title: 'Wedding Planner — the free couple wedding website', body: 'Every couple in Wedding Planner can build a free, mobile-first wedding website inside their own StoryVenue login (couple side, Website tab) — no separate Knot or Zola account. It is a simple linktree-style page dressed up as a wedding site, hosted at storyvenue.com/their-custom-link, one link to share on invitations, texts, and social. Couples add a photo and cover, names, headline, story, a live countdown, their socials, and up to six custom link buttons (registry, hotel block, travel, livestream, schedule), plus online RSVP where guests find their invite by name and reply with headcount, meal choice, and dietary notes, and a guestbook the couple can moderate. When the couple turns on the Our Venue card, the website links back to the venue public listing for extra exposure. They pick a custom link (availability-checked), toggle sections, hit Publish, and can copy the link or download a QR code. To point a couple to it: once connected, tell them to log in and open the Website tab. RSVPs they collect flow into the same guest-list rollup the venue already sees. Good tour and package talking point: book with us and get a free wedding website.' },
  // Team
