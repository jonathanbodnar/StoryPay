...
const ARTICLES = [
  ...
  // Team
  { id: 'team-invite',    tags: ['team','invite','add member','staff','user','email invite'], title: 'Inviting team members',                    body: 'Go to Settings Team. Click Add Team Member. Fill in name, email, role. Member receives a branded invitation email with Accept Invitation button. Resend, edit, or remove via the menu.' },
  { id: 'team-roles',     tags: ['roles','permissions','owner','admin','member','access'],    title: 'Team roles and permissions',                body: 'Three roles: Owner full access including calendar, settings, and integrations. Admin manage proposals, customers, calendar, most settings. Member view proposals, customers, calendar only.' },
  // Notifications
  ...
  // Ask AI
  { id: 'ai-overview',    tags: ['ask ai','ai','chat','assistant','help'],                   title: 'What is Ask AI?',                           body: 'Ask AI is your built-in assistant powered by live account data. Knows revenue, proposals, customer pipeline. Open by clicking the sparkle button. Ask about the platform or your account.' },
