...
export const DIRECTORY_NAV_REGISTRY: DirectoryNavRegistryEntry[] = [
  ...
  { id: 'nav_main_floor', label: 'Floor', pathPrefix: '/dashboard/floor', group: 'main' },
  ...
  { id: 'nav_payments_packages', label: 'Payments — Packages', pathPrefix: '/dashboard/payments/packages', group: 'payments' },
  ...
  { id: 'nav_marketing_email_automations', label: 'Marketing — Email workflows', pathPrefix: '/dashboard/marketing/email/automations', group: 'marketing' },
...
export const DIRECTORY_LEGACY_FEATURE_TO_NAV_IDS: Record<string, string[]> = {
  ...
  leads: ['nav_main_leads', 'nav_main_floor'],
...
export function coarseFeatureFlagsFromNavPermissions(nav: Record<string, boolean>): Record<string, boolean> {
  ...
  return {
    ...
    floor: get('nav_main_floor') || get('nav_main_leads'),
