...
export const DIRECTORY_NAV_REGISTRY: DirectoryNavRegistryEntry[] = [
  ...
  { id: 'nav_listing_bride_portal', label: 'Wedding Planner', pathPrefix: '/dashboard/wedding-planner', group: 'listing' },
  ...
  { id: 'nav_settings_push', label: 'Settings — Push Notifications', pathPrefix: '/dashboard/settings/push', group: 'settings' },
