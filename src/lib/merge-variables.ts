...
export const SYSTEM_MERGE_VARIABLES: SystemMergeVar[] = [
  ...
  { key: 'venue.pricing_guide_url',     tag: '{{venue.pricing_guide_url}}',     description: 'Link to the branded Pricing & Availability Guide preview page — opens PDF inline with a Download button (always latest version)', example: 'https://app.storyvenue.com/guide/abc123', category: 'venue', usedIn: ['marketing'] },
  ...
  { key: 'ai.assistant_persona_name',   tag: '{{ai.assistant_persona_name}}',   description: "AI assistant display name — the venue owner's first name (falls back to venue name)", example: 'Sarah',                        category: 'ai',           usedIn: ['ai_concierge'] },
