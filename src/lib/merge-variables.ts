...
export const SYSTEM_MERGE_VARIABLES: SystemMergeVar[] = [
  ...
  { key: 'venue.pricing_guide_url',     tag: '{{venue.pricing_guide_url}}',     description: 'Link to the branded Pricing & Availability Guide preview page — opens PDF inline with a Download button (always latest version)', example: 'https://app.storyvenue.com/venue/abc123/guide', category: 'venue', usedIn: ['marketing'] },
