...
export const SYSTEM_TAG_DEFS: SystemTagDef[] = [
  ...
  { system_key: 'email_lead',         name: 'Email Lead',          category: 'Referral',        description: 'Captured by LeadFinder from an email (directory notice or forwarded inquiry)', auto_apply_events: [],                    color: '#7c3aed' },
