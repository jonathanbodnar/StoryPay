...
Reach out while they are hot — open their contact to start the conversation.`,
  ...
  // contact record — button_text only changes its label.
  {
    ...
    editable: true,
    defaults: {
      subject: 'Urgent: {{bride_full_name}} needs your attention — {{venue_name}}',
      heading: '{{bride_first_name}} just sent a message that needs you NOW',
      body: `{{bride_first_name}} replied to a message from your StoryVenue Concierge Team with something that needs your attention right away. We've paused outreach and are waiting for you to take over.`,
  ...
  },
  {
    ...
    defaults: {
      ...
      body: `{{bride_first_name}} replied to a message from your StoryVenue Concierge Team asking about pricing, packages, or rates. Pricing questions are always handed off so a real person on your team can share the real answer.`,
  ...
  },
  {
    ...
    defaults: {
      ...
      body: `Great news — {{bride_first_name}} just replied to a follow-up from your StoryVenue Concierge Team. We've paused outreach so you (or your team) can take over the conversation. The sooner you respond, the warmer she'll feel.`,
      button_text: 'Reply to her now →',
    },
  },
  {
    ...
    defaults: {
      ...
      body: `{{bride_first_name}} replied to a follow-up from your StoryVenue Concierge Team indicating she's no longer interested or has chosen another venue. We've moved her to your "Not Interested" pipeline and stopped all future outreach to her.`,
  ...
  },
  {
    ...
    defaults: {
      ...
      body: `{{bride_first_name}} replied with a TCPA opt-out keyword (STOP, UNSUBSCRIBE, etc.). She will not receive any more SMS messages from your account — this is a legal compliance requirement and cannot be undone on our side. You can still reach out via email or other channels.`,
      button_text: 'View her contact record →',
    },
  },
  {
  ...
  },
  {
    ...
    defaults: {
      ...
      heading: '{{bride_first_name}} replied — time to step in',
      body: `{{bride_first_name}} replied to a follow-up from your StoryVenue Concierge Team. This conversation needs a real person right now — the faster you respond, the warmer she'll feel. Don't let this one go cold.`,
      button_text: 'Reply to her now →',
    },
  },
  {
    ...
    defaults: {
      ...
      body: `Your StoryVenue Concierge Team completed its full 60-day follow-up sequence for {{bride_first_name}} without ever getting a reply. She has been moved to your "Not Interested" pipeline stage and is no longer considered a warm lead. No further messages will be sent. If she ever replies in the future, she'll automatically move back to "Conversation Started" and you'll be notified.`,
      button_text: 'View her contact record →',
    },
  },
  {
