...
function buildHtml(tpl: TemplateOverride, vars: Record<string, string>): string {
  ...
  return buildSystemEmail({
    ...
    footerHtml: `<p style="margin:0;font-size:11px;color:#9ca3af;text-align:center;">Sent by StoryVenue &middot; <a href="${APP_URL}/unsubscribe" style="color:#9ca3af;">Unsubscribe</a></p>`,
  });
}
