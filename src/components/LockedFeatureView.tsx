...
const FEATURE_OUTCOMES: Record<string, FeatureOutcome> = {
  ...
  nav_listing_bride_portal: {
    ...
    outcome:
      'Give every booked couple a private Wedding Planner to plan their day with you — guest list, RSVPs, meal selections, and shared messaging in one place. No more chasing headcounts across email, texts, and spreadsheets, and a differentiator you can upsell into your packages.',
    upgradeNote:
