...
export default function DateRangePicker({ value, onChange }: Props) {
 ...
 <div className="hidden sm:block w-44 border-r border-gray-200 py-2 flex-shrink-0">
 ...
 className="flex-1 rounded-2xl border border-gray-200 px-4 py-2.5 text-sm font-medium text-gray-600 hover:bg-gray-50 transition-colors">
 Cancel
 </button>
 ...
 <div className="flex flex-col bg-white rounded-2xl overflow-y-auto"
 ...
 ref={btnRef}
 onClick={openPicker}
          className="inline-flex h-10 items-center gap-2 rounded-lg border border-gray-200 bg-white px-3.5 text-sm font-medium text-gray-700 transition-all hover:border-gray-300"
 >
