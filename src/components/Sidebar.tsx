...
const topMenuItems: NavItem[] = [
  ...
  { label: 'Wedding Planner', href: '/dashboard/wedding-planner', icon: Heart, navId: 'nav_listing_bride_portal' },
        ...
        {!isNativeApp() && !rail && (
          <div className="grid grid-cols-2 gap-2 px-1 py-2">
            ...
            >
              ...
              <div>
                <div className="text-white whitespace-nowrap" style={{ fontSize: 7, lineHeight: '9px', opacity: 0.7 }}>Download on the</div>
                <div className="text-white font-semibold whitespace-nowrap" style={{ fontSize: 11, lineHeight: '14px' }}>App Store</div>
              </div>
            </a>
            {/* Google Play */}
            <a
            ...
            >
              ...
              <div>
                <div className="text-white whitespace-nowrap" style={{ fontSize: 7, lineHeight: '9px', opacity: 0.7, letterSpacing: '0.05em' }}>GET IT ON</div>
                <div className="text-white font-semibold whitespace-nowrap" style={{ fontSize: 11, lineHeight: '14px' }}>Google Play</div>
              </div>
            </a>
          </div>
        )}
