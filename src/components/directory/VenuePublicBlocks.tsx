...
// MapboxVenueMap is a 'use client' component — Next.js automatically treats it
// as a client boundary so it never runs during SSR.
import MapboxVenueMap from './MapboxVenueMap';
  ...
  return (
    <section className="space-y-3">
      ...
      <div className="relative overflow-hidden rounded-2xl border border-gray-200 bg-white">
        <MapboxVenueMap lat={lat} lng={lng} venueName={venueName} />
        <a
