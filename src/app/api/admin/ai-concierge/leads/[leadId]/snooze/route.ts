/**
 * PATCH /api/admin/ai-concierge/leads/[leadId]/snooze
 *
 * Push the next scheduled send forward by 1, 2, or 3 days (admin choice).
 * Useful when the bride says "reach out next week" and the team wants to
 * honour that without pausing the AI entirely.
 *
 * Body: { days: 1 | 2 | 3 }
 */
