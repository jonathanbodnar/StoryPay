...
- Tagline: "Wedding Planner — one shared place for you and your venue." Path: sidebar → **Wedding Planner** (heart icon, top-level, /dashboard/wedding-hub). The same "Wedding Planner" name appears in the couple's own login, so both sides know exactly where to go.
