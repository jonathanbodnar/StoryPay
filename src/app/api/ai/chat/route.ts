...
- **Download** streams through `/api/venue-media/<id>/download` so the browser receives `Content-Disposition: attachment` and saves the file to the user's computer (the previous direct cross-origin link was being opened in a new tab instead of downloaded).
