...
- **Connect**: paste your sub-account Location ID and a Private Integration Token (pit-...) or a Location API Key. The form auto-detects the token type. Once connected the venue gets a green "Connected" badge.
