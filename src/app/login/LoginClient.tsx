...
function CoupleLoginForm({
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Native brides land in the "My wedding" hub; the web keeps the wish-list
      // dashboard as the default landing area.
      const fallback = isNativeApp() ? '/couple/wedding' : '/couple/dashboard';
