...
function MemberResetForm() {
  ...
  useEffect(() => {
    if (!token) setError('No reset token found. Please ask your account manager to resend the link.');
  }, [token]);
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true);
    try {
      const res = await fetch('/api/auth/member/reset', {
        method: 'POST',
          ...
          {done ? (
            ...
            <>
              ...
              <p className="text-sm text-gray-500 mb-6">
                Choose a password for your StoryVenue team account.
              </p>
