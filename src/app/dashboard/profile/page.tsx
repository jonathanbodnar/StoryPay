        ...
        <form onSubmit={save} className="px-6 py-5 space-y-4">
          ...
          <div className="flex items-center justify-between pt-1">
            ...
            <button
              type="submit"
              disabled={saving}
              className="ml-auto flex items-center gap-2 rounded-xl px-5 py-2.5 text-sm font-bold text-white hover:opacity-90 disabled:opacity-60 transition-all shadow-sm"
              style={{ backgroundColor: '#1b1b1b' }}
            >
