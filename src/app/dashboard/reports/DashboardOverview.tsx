...
function BrandTooltip({ active, payload, label }: { active?: boolean; payload?: { value: number }[]; label?: string }) {
 ...
 return (
 <div className="rounded-2xl border px-3.5 py-2.5 text-sm"style={{ borderColor: B.light, backgroundColor: '#fff' }}>
...
export function DashboardOverview() {
 ...
 <Link href="/dashboard/payments/proposals"
  ...
  {trendsLoading || !bookingTrends ? (
   ...
   <>
    ...
    <p className="mt-4 text-[11px] text-gray-400">
     ...
     <Link href="/dashboard/payments/proposals" className="font-medium text-gray-600 hover:text-gray-900 underline-offset-2 hover:underline">
      Proposals
     </Link>{' '}
     page.
    </p>
