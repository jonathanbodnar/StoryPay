...
import { ArrowLeft, Mail, Phone, MapPin, FileText, Loader2, ExternalLink } from 'lucide-react';
  ...
  if (error || !customer) {
    return (
      <div className="py-20 text-center">
        ...
        <button
          onClick={() => router.back()}
          className="mt-4 text-sm text-brand-900 hover:underline"
        >
          Go back
        </button>
      </div>
    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        <div className="rounded-xl border border-gray-100 p-5">
          <p className="text-[11px] font-semibold uppercase tracking-wider text-gray-400">Total Proposals</p>
      ...
      {/* Proposals list */}
      <h2 className="font-heading text-lg text-gray-900 mb-4">Proposals</h2>
