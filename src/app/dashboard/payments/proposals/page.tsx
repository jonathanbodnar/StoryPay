          ...
          <div>
            ...
            {sent.length === 0 && drafts.length === 0 ? (
              <div className="py-16 text-center rounded-2xl border border-dashed border-gray-200 bg-white">
                ...
                <Link href="/dashboard/payments/new" className="mt-4 inline-flex items-center gap-2 rounded-xl px-4 py-2.5 text-sm font-bold text-white hover:opacity-90 shadow-sm" style={{ backgroundColor: '#1b1b1b' }}><Plus size={14}/>Create First Proposal</Link>
              </div>
            ) : (
