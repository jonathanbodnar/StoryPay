...
const INPUT = 'w-full rounded-xl border border-gray-200 bg-white px-3.5 py-2.5 text-sm text-gray-900 placeholder:text-gray-400 focus:border-gray-400 focus:outline-none transition-colors';
...
function LivePreview({
  ...
  return (
    <div className="rounded-2xl border border-gray-200 overflow-hidden shadow-sm bg-white text-sm">
      {/* Branded header */}
      ...
      <div className="px-5 py-4 space-y-4">
        ...
        <div className="rounded-xl border border-gray-100 overflow-hidden">
          <div className="px-3 py-2 bg-gray-50 border-b border-gray-100 grid grid-cols-[1fr_80px] text-[10px] font-semibold uppercase tracking-wider text-gray-400">
          ...
          <div className="px-3 py-2 border-t-2 border-gray-100 grid grid-cols-[1fr_80px]">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <button onClick={()=>submit(false)} disabled={saving||submitting}
            className="flex items-center gap-2 rounded-xl px-5 py-2.5 text-sm font-bold text-white shadow-sm hover:opacity-90 disabled:opacity-50 transition-all"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-6 items-start">
        ...
        <div className="space-y-5">
          ...
          {mode==='proposal' && (
            <div className="rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden">
              ...
              <div className="px-5 py-4 space-y-3">
                ...
                {selectedTemplate && (
                  <div className="rounded-xl border border-amber-100 bg-amber-50 px-3.5 py-2.5 text-xs text-amber-700">
                ...
                {!showEditor && contractHtml && (
                  <div className="rounded-xl border border-gray-100 bg-gray-50 px-4 py-3 max-h-24 overflow-hidden relative">
          ...
          <div className="rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden">
            ...
            <div>
              {/* Desktop headers */}
              <div className="hidden sm:grid grid-cols-[1fr_180px_110px_36px] gap-3 bg-gray-50 px-5 py-2.5 border-b border-gray-100">
              ...
              <div className="flex flex-wrap gap-2">
                {([
                  ...
                  <button key={pt.key} type="button" onClick={()=>setPaymentType(pt.key)}
                    className={`rounded-xl border-2 px-4 py-2 text-sm font-medium transition-all ${paymentType===pt.key?'border-gray-900 bg-gray-50 text-gray-900':'border-gray-200 text-gray-500 hover:border-gray-300'}`}>
                    {pt.label}
                  </button>
                ))}
              </div>
                  ...
                  {installments.map(inst=>(
                    <div key={inst.id} className="flex items-center gap-2">
                      ...
                      <input type="date" min={today()} value={inst.date}
                        ...
                        className="rounded-xl border border-gray-200 px-3 py-2.5 text-sm focus:border-gray-400 focus:outline-none"/>
              ...
              {paymentType==='subscription' && (
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <div>
                    ...
                    <div className="relative">
                      <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 text-sm">$</span>
                      <input type="number" min="0" step="0.01" value={subAmount} onChange={e=>setSubAmount(e.target.value)} placeholder="0.00" className="w-full rounded-xl border border-gray-200 pl-7 pr-3 py-2.5 text-sm focus:border-gray-400 focus:outline-none"/>
                    </div>
                  </div>
                  <div>
                    <label className="block text-xs font-medium text-gray-500 mb-1.5">Frequency</label>
                    <select value={subFrequency} onChange={e=>setSubFrequency(e.target.value)} className="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm focus:border-gray-400 focus:outline-none appearance-none">
                  ...
                  <div>
                    ...
                    <input type="date" min={today()} value={subStartDate} onChange={e=>setSubStartDate(e.target.value)} className="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm focus:border-gray-400 focus:outline-none"/>
                  </div>
                </div>
              )}
            </div>
