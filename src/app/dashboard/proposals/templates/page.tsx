...
export default function TemplatesPage() {
 ...
 <div className="relative w-full max-w-3xl bg-white rounded-2xl flex flex-col overflow-hidden"style={{ maxHeight: '90vh' }}>
 {/* Header — never scrolls */}
 <div className="flex-shrink-0 flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-white rounded-t-2xl z-10">
 <div>
 ...
 <div className="h-12 rounded-2xl border-2 border-dashed border-gray-300 flex items-center justify-center">
