...
import { Mail, MessageSquare, Loader2, Save, CheckCircle2, CreditCard } from 'lucide-react';
...
export default function NotificationsPage() {
  ...
  return (
    <div>
      {/* Header */}
      <div className="mb-8">
        <h1 className="font-heading text-2xl text-gray-900">Payment Notifications</h1>
        <p className="mt-1 text-sm text-gray-500">
          Choose how you and your customers are notified about payment-related events.
          Appointment reminders are configured in <a href="/dashboard/settings/calendar" className="text-gray-900 underline">Calendar settings</a>.
        </p>
      </div>
          ...
          <div className="flex items-center gap-2.5 px-6 py-4 border-b border-gray-200">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 mt-0.5">
                ...
                The body uses your branded <a href="/dashboard/settings/email-templates" className="underline">Payment Reminder template</a>.
              </p>
            </div>
          </div>
