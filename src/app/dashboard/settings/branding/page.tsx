    ...
    <div className="rounded-2xl border border-gray-200 overflow-hidden shadow-sm bg-white">
      ...
      <div className="px-6 py-4">
        ...
        <div className="border border-gray-100 rounded-xl overflow-hidden mb-4">
          ...
          <div className="px-4 py-3 grid grid-cols-[1fr_80px] border-t-2 border-gray-100">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 space-y-2">
                    ...
                    <button type="button" onClick={() => fileRef.current?.click()} disabled={logoUploading}
                      className="flex items-center gap-2 rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-all disabled:opacity-50 shadow-sm w-full justify-center">
