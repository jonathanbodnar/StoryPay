    ...
    <div className="text-gray-900" style={{ fontFamily: "'Open Sans', Arial, sans-serif", background: 'linear-gradient(180deg, #e4e9ec 0%, #eef1f3 8%, #f4f6f7 18%, #f8f9fa 30%, #ffffff 48%)' }}>
      ...
      <div className="relative">
        ...
        <nav className="mx-auto max-w-5xl px-5 sm:px-8 py-5 flex items-center justify-between">
          ...
          <a href={`${DASHBOARD_URL}/login`} className="rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-all">
            Log In
          </a>
        </nav>
      ...
      <footer className="py-8 px-4 border-t border-gray-100">
        <div className="mx-auto max-w-5xl flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-4 text-xs text-gray-400">
            ...
            <a href={`${DASHBOARD_URL}/admin`} className="hover:text-gray-600 transition-colors">Admin</a>
          </div>
        </div>
      </footer>
