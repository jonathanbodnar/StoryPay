      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-gray max-w-none space-y-8 text-sm leading-relaxed text-gray-700">
          ...
          <section>
            ...
            <p>StoryPay may send SMS messages to your customers using your connected StoryVenue Legacy account and A2P-registered phone number. You are responsible for ensuring you have proper consent from your customers to receive SMS communications as required by applicable law (including TCPA).</p>
          </section>
