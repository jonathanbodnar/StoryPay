 ...
 * auto-appends on every paid-ad click (stored in sessionStorage before
 * client-side navigation clears the URL), and the browser referrer as a
 * zero-setup fallback for untagged traffic.
 */
