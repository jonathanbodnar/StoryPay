...
export type VenueFaqItem = { question: string; answer: string };
    ...
    <section className="space-y-3">
      ...
      <div className="relative overflow-hidden rounded-2xl border border-gray-200 bg-white">
        <iframe
          ...
          src={iframeSrc}
        />
        {/* Red pin overlay anchored to the exact map center, which matches
            the bbox we computed around (lat, lng). */}
...
export function VenueSocialRow({ social }: { social: VenueSocial }) {
